...
public class CoolCamera extends OrthographicCamera {
	...
	/**
	 * Changed the size of camera so that no "black bars" are visible. Also
	 * positions the camera to focus on the player entity's position.
	 * 
	 * @param width
	 *            the width of the board in pixels (e.g. xSize *
	 *            Constants.GRID_CELL_SIZE)
	 * @param height
	 *            the height of the board in pixels (e.g. ySize *
	 *            Constants.GRID_CELL_SIZE)
	 * @param player
	 *            the player entity on which camera focuses
	 */
